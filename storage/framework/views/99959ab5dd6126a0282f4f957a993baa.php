                        ...
                        <form action="" method="get">
                            <div class="row p-1">
                                <div class="form-group  col-md-3">
                                    <select class="form-control" name="class_id" id="getClass" required>
                                        ...
                                        <?php $__currentLoopData = $getClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e(Request('class_id') == $class->classe_id ? 'selected' : ''); ?>

                                                value="<?php echo e($class->classe_id); ?>"><?php echo e($class->class_name); ?></option>
                                ...
                                <div class="form-group col-md-3 d-flex align-items-center">
                                    ...
                                    <a href="<?php echo e(route('teacher.attendance.student')); ?>" class="btn btn-success btn-outlook"
                                        role="button">Reset</a>
                                </div>
                            </div>
                        </form>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        $('.saveAttendance').change(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('teacher.attendance.student.save')); ?>",
                data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sms\resources\views/teacher/attendance/student.blade.php ENDPATH**/ ?>