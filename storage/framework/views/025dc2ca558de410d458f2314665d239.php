                                ...
                                <div class="form-group  col-md-3">
                                    <select class="form-control" name="exam_id" required>
                                        ...
                                        <?php $__currentLoopData = $getExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e(Request('exam_id') == $exam->exam_id ? 'selected' : ''); ?>

                                                value="<?php echo e($exam->exam_id); ?>"><?php echo e($exam->exam_name); ?></option>
                                ...
                                <div class="form-group  col-md-3">
                                    <select class="form-control" name="class_id" required>
                                        ...
                                        <?php $__currentLoopData = $getClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e(Request('class_id') == $class->class_id ? 'selected' : ''); ?>

                                                value="<?php echo e($class->class_id); ?>"><?php echo e($class->class_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        $('.submitMarks').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('teacher/submit_marks_register')); ?>",
                data: $(this).serialize(),
                dataType: "json",
        ...
        $('.saveSingleSubject').click(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('teacher/single_submit_marks_register')); ?>",
                data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sms\resources\views/teacher/marks_register.blade.php ENDPATH**/ ?>