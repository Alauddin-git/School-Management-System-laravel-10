    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="<?php echo e(route('admin.student.add.perform')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="name">First Name</label><span style="color:red;">*</span>
                                <input type="text" id="name" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="Enter First Name" required>
                                <div style="color: red"><?php echo e($errors->first('name')); ?></div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="last_name">Last Name</label><span style="color:red;">*</span>
                                <input type="text" id="last_name" class="form-control" name="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="Enter Last Name" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="admission_number" class="form-control" name="admission_number" value="<?php echo e(old('admission_number')); ?>" placeholder="Enter Admission Number" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="roll_number" class="form-control" name="roll_number" value="<?php echo e(old('roll_number')); ?>" placeholder="Enter Roll Number" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="classe_id" id="class_id" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $getClassAssigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getClassAssign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e((old('classe_id') == $getClassAssign->id)?'selected':''); ?> value="<?php echo e($getClassAssign->id); ?>"><?php echo e($getClassAssign->name); ?></option>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" id="date_of_birth" class="form-control" name="date_of_birth" value="<?php echo e(old('date_of_birth')); ?>" required>
                                <div style="color: red"><?php echo e($errors->first('date_of_birth')); ?></div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="caste">Caste</label><span style="color:red;">*</span>
                                <input type="text" id="caste" class="form-control" name="caste" value="<?php echo e(old('caste')); ?>" placeholder="Enter Caste" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="religion" class="form-control" name="religion" value="<?php echo e(old('religion')); ?>" placeholder="Enter Religion" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="mobile_number" class="form-control" name="mobile_number" value="<?php echo e(old('mobile_number')); ?>" placeholder="Enter Mobile Number" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" id="admission_date" class="form-control" name="admission_date" value="<?php echo e(old('admission_date')); ?>" placeholder="Enter Admission Date" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="Blood_group" class="form-control" name="blood_group" value="<?php echo e(old('blood_group')); ?>" placeholder="Enter Blood Group" required>
                                <div style="color: red"><?php echo e($errors->first('blood_group')); ?></div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="height">Height</label><span style="color:red;">*</span>
                                <input type="text" id="height" class="form-control" name="height" value="<?php echo e(old('height')); ?>" placeholder="Enter Height" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="weight" class="form-control" name="weight" value="<?php echo e(old('weight')); ?>" placeholder="Enter Weight" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option <?php echo e((old('status') == 0)?'selected':''); ?> value="0">Active</option>
                                    <option <?php echo e((old('status') == 1)?'selected':''); ?> value="1">Inactive</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter email" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sms\resources\views/admin/student/add.blade.php ENDPATH**/ ?>