        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @if (Auth::user()->user_type == 1)
                    ...
                    <li
                        class="nav-item {{ in_array(Request::segment(3), ['student', 'report']) ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ in_array(Request::segment(3), ['student', 'report']) ? 'active' : '' }}">
                            <i class="nav-icon fas fa-table"></i>
                            <p>
                                Attendance
                                <i class="fas fa-angle-left right"></i>
                ...
                @elseif(Auth::user()->user_type == 2)
                    ...
                    <li class="nav-item">
                        <a href="{{ route('teacher.my_calendar') }}"
                            class="nav-link @if (Request::segment(3) == 'calendar') active @endif">
                            <i class="nav-icon far fa-user"></i>
                            <p>
                                My Calendar
                            </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('teacher.attendance.student') }}"
                                class="nav-link {{ Request::segment(3) == 'student' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Student Attendance</p>
                            </a>
                ...
                @elseif(Auth::user()->user_type == 3)
                    ...
                    <li class="nav-item">
                        <a href="{{ route('student.my_exam_result') }}"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('student.my_attendance') }}"
