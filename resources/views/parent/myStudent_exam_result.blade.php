    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>My Exam Result(name: <span style="color: blue">{{ $getStudent->name }} {{ $getStudent->last_name }}</span>, Class-<span style="color: blue">{{ $mySubjects->first()->class_name }}</span>)</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
